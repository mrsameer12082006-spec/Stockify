...
1⃣ Demand Analysis (analytics/demand_analysis.py)
...
2⃣ Trend Analysis (analytics/trend_analysis.py)
...
3⃣ KPI Calculations (analytics/kpi_calculator.py)
...
category  : string (can be empty → treated as "Uncategorized")
 ...
 Analytics DOES NOT clean or validate raw data.
